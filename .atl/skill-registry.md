# Skill Registry — simbiosis-catalog-2
...
- C:\Users\Nicolas\.config\opencode\skills
- C:\Users\Nicolas\.claude\skills
- C:\Users\Nicolas\.copilot\skills
...
| `go-testing` | Trigger: Go tests, go test coverage, Bubbletea teatest, golden files. Apply focused Go testing patterns. | user | `C:\Users\Nicolas\.config\opencode\skills\go-testing\SKILL.md` |
...
| `judgment-day` | Trigger: judgment day, dual review, adversarial review, juzgar. Run blind dual review, fix confirmed issues, then re-judge. | user | `C:\Users\Nicolas\.config\opencode\skills\judgment-day\SKILL.md` |
